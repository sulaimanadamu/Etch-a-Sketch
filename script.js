...
function eventListeners(){
    ...
    const handleTouch = (event) => {
        ...
        else if(touchedElement && touchedElement.classList.contains('block')){
            touchedElement.style.backgroundColor = generateRandomHexCode()
        }
      };
    
    
      tileContainer.addEventListener('touchmove', handleTouch);
